...
urlpatterns = i18n_patterns(
    ...
    path(
        "project/<int:project_id>/hierarchy/",
        project.hierarchy,
        name="project-hierarchy",
    ),
    path("project/<int:project_id>/report/", project.report, name="project-report"),
    path("project/<int:project_id>/widgets/", project.widgets, name="project-widgets"),
    path(
        "project/<int:project_id>/updates/",
        project_update.project_updates,
        name="project-updates",
    ),
    path(
        "project/<int:project_id>/partners/", project.partners, name="project-partners"
    ),
    path("project/<int:project_id>/finance/", project.finance, name="project-finance"),
    # Organisations
